    ...
    <>
      ...
      <aside className="admin-drawer">
        <div className="admin-drawer__header">
          <div>
            <p className="admin-drawer__eyebrow">Private admin access</p>
            ...
            <div className="student-photo-preview student-photo-preview--interactive">
              ...
              <div className="student-photo-overlay">
                <button
                  ...
                  onClick={() => {
                    const input = document.getElementById(`student-photo-input-${student.id}`)
                    if (input) input.click()
                  }}
                >
                  {student.photoUrl ? 'Replace' : 'Upload'}
                </button>
                ...
                {student.photoUrl && (
                  <button
                    ...
                    onClick={() => onRemoveStudentPhoto(student.id)}
                  >
                    Remove
                  </button>
                )}
              ...
              <input
                id={`student-photo-input-${student.id}`}
                type="file"
                accept="image/*"
                className="file-input-hidden"
                onChange={(e) => onStudentPhotoUpload(student.id, e.target.files?.[0] || null)}
              />
            </div>
          </div>
            ...
            <div className="drawer-panel">
              <div className="section-head section-head--stack">
                <div>
                  ...
                  <p className="section-head__sub">
                    Edit basic details and control what students can see.
                  </p>
                </div>
                ...
                <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                  ...
                  >
                    <span className="btn-plus">✏️</span> Edit
                  </button>
              ...
              <div className="vis-banner">
                <div className="vis-banner__text">
                  ...
                  <span>When public, the photo &amp; profile appear to other students for inspiration.</span>
                </div>
                <VisibilityToggle
                  value={visibility.profile || 'private'}
                  onChange={(v) => onSetVisibility(student.id, 'profile', v)}
                />
              </div>
              ...
              <div className="info-grid">
                ...
                <div className="info-card info-card--with-toggle">
                  ...
                  <VisibilityToggle
                    ...
                    onChange={(v) => onSetVisibility(student.id, 'email', v)}
                  />
                </div>
                <div className="info-card info-card--with-toggle">
                  <div>
                  ...
                  <VisibilityToggle
                    ...
                    onChange={(v) => onSetVisibility(student.id, 'phone', v)}
                  />
                </div>
              </div>
              ...
              <div className="notes-block">
                <div className="section-head">
                  ...
                  <VisibilityToggle
                    value={visibility.notes || 'private'}
                    onChange={(v) => onSetVisibility(student.id, 'notes', v)}
                  />
                </div>
                ...
                <div className="notes-box">
                  <textarea
                    ...
                    onBlur={(e) => onUpdateNotes(student.id, e.target.value)}
                    rows={8}
                  ></textarea>
                </div>

                <div className="private-warning">
                  Keep sensitive comments private. Public notes become visible to other students.
                </div>
              </div>
            </div>
          )}
            ...
            <div className="drawer-panel">
              <div className="section-head section-head--stack">
                ...
                <button
                  className="solid-btn solid-btn--sm"
                  type="button"
                  onClick={() => onAddApplication(student.id)}
                >
                        ...
                        <div className="application-card__expand">
                          <div className="application-toolbar">
                            <VisibilityToggle
                              ...
                              onChange={(v) =>
                                onSetApplicationVisibility(student.id, application.id, v)
                              }
                            />
                            ...
                            <div className="application-toolbar__actions">
                              <button
                                type="button"
                                className="mini-btn"
                                onClick={() => onEditApplication(student.id, application.id)}
                              >
                                Edit
                              </button>
                              ...
                              <button
                                type="button"
                                className="mini-btn mini-btn--danger"
                                onClick={() => onDeleteApplication(student.id, application.id)}
                              >
                                Delete
                              </button>
                            </div>
                          ...
                          <div className="doc-groups">
                            {DOC_CATEGORIES.map((category) => (
                              <DocumentGroup
                                ...
                                category={category}
                                onUpload={onUploadApplicationFile}
                                onRemove={onRemoveApplicationFile}
                                onOpenInline={(doc) => setActivePdf(doc)}
                              />
                            ))}
                          </div>
                        </div>
              ...
              {!student.applications.length && (
                <div className="empty-state empty-state--cert">
                  ...
                  <p>Create the first university application for this student.</p>
                  <button
                    className="solid-btn solid-btn--sm"
                    type="button"
                    onClick={() => onAddApplication(student.id)}
            ...
            <div className="drawer-panel">
              <div className="section-head section-head--stack">
                <div>
                  ...
                  <p className="section-head__sub">
                    Certifications, standardized tests, and credentials.
                  </p>
                </div>
                <button
                  className="solid-btn solid-btn--sm"
                  type="button"
                  onClick={() => onAddLicense(student.id)}
                >
              ...
              <div className="cert-list">
                    ...
                    <div className="cert-item__body">
                      <div className="cert-item__row">
                        ...
                        <div className="cert-item__actions">
                          <button
                            ...
                            className="icon-btn"
                            title="Edit"
                            onClick={() => onEditLicense(student.id, license.id)}
                          >
                            ✏️
                          </button>
                          <button
                            ...
                            title="Delete"
                            onClick={() => onDeleteLicense(student.id, license.id)}
                          >
                            🗑️
                          </button>
                        </div>
                      ...
                      <div className="cert-item__foot">
                        <VisibilityToggle
                          ...
                          onChange={(v) => onSetLicenseVisibility(student.id, license.id, v)}
                        />
                        ...
                        {(license.media || []).map((m) => (
                          <span key={m.id} className="pill-link pill-link--file">
                            ...
                            <button
                              type="button"
                              className="chip-x"
                              onClick={() => onLicenseMediaRemove(student.id, m.id)}
                              title="Remove"
                            >
                              ✕
                            </button>
                        ...
                        <input
                          ...
                          className="file-input-hidden"
                          onChange={(e) => {
                            onLicenseMediaUpload(student.id, license.id, e.target.files?.[0])
                            e.target.value = ''
                          }}
                        />
                      </div>
                ...
                {!licenses?.length && (
                  <div className="empty-state empty-state--cert">
                    <div className="empty-state__icon">🎓</div>
                    <h4>No licenses or certifications yet</h4>
                    <p>Add IELTS, SAT, AP, or other credentials with score and evidence.</p>
                    <button
                      className="solid-btn solid-btn--sm"
                      type="button"
                      onClick={() => onAddLicense(student.id)}
