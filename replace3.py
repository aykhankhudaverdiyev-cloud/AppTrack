                      ...
                      <div className="application-card__expand">
                        ...
                        <div className="application-card__meta">
                          <div className="meta-cell">
                            <span>Term</span>
                            <strong>{application.term or "—"}</strong>
                          </div>
                          <div className="meta-cell">
                            <span>Major</span>
                            <strong>{application.major or "—"}</strong>
                          </div>
                          <div className="meta-cell">
                            <span>Decision</span>
                            <strong>{application.decision or "—"}</strong>
                          </div>
                          <div className="meta-cell">
                            <span>Recommendation</span>
                            <strong>{application.recommendation or "—"}</strong>
                          </div>
                          <div className="meta-cell">
                            <span>Deadline</span>
                            <strong>{application.deadline or "—"}</strong>
                          </div>
                          <div className="meta-cell">
                            <span>Status</span>
                            <strong>{application.status or "—"}</strong>
                          </div>
                        </div>
